...
winget install VoodooSoft.DefenderUI #DefenderUI
...
winget install vscode-powershell #PowerShell Extension for VSCode
winget install GitHub Desktop
winget install GitHub.cli
winget install Git.Git #Git Version Control
...
winget install Python.Python.3.14.Launcher
...
winget install 9PBL2KQXQ47K #CorelDRAW #CorelDRAW Graphics Suite 2024
