local Power_of_Nature = {
     ...
     out = function(t)
          ModLog("Alarielle's Global World Torment And True Power of Nature: " ..
               tostring(t) .. ".")
     end

};

local Alarielle = { faction_key = "wh2_main_hef_avelorn" }
...
function Power_of_Nature:Start_Power_of_Nature_Listeners()
     cm:add_faction_turn_start_listener_by_name("Power_of_Nature",
          Alarielle.faction_key,
          function(context)
               ...
               if character:has_region() and not character:is_at_sea() then
                    ...
                    self.out("region's owning faction's name: " ..
                         region:owning_faction():name() ..
                         ", region_owning_faction:name() == " ..
                         region_owning_faction:name() .. "")
                    self.out("region's culture is: " .. region_culture .. "")
                    self.out(
                         "is region abandoned?: " .. tostring(region:is_abandoned()) ..
                         "")

                    if not region:is_abandoned() and
                        alarielle_faction:at_war_with(region_owning_faction) == false and
                        self["cultures"][region_culture] ~= nil then
                         if region:has_effect_bundle(self.effect_bundle_key) then
                              cm:remove_effect_bundle_from_region(self.effect_bundle_key,
                                   region_key);
                         end

                         self.out("cm:apply_effect_bundle_to_region" .. "")

                         cm:apply_effect_bundle_to_region(self.effect_bundle_key,
                              region_key, 15);
                         self.regions[region_key] = 15;

                         cm:add_garrison_residence_vfx(
                              region:garrison_residence():command_queue_index(),
                              self.vfx.full, false);
     ...
     core:add_listener("Power_of_Nature_Region", "RegionTurnStart", function(
               context)
          ...
          function(context)
               ...
               if turns_remaining > 7 then
                    -- display full VFX
                    cm:add_garrison_residence_vfx(garrison_residence_cqi, self.vfx.full,
                         false);
                    self.regions[region_key] = turns_remaining;
               elseif turns_remaining > 0 then
                    -- switch to half strength VFX
                    cm:add_garrison_residence_vfx(garrison_residence_cqi, self.vfx.half,
                         false);
                    self.regions[region_key] = turns_remaining;
               else
...
function add_alarielle_listeners()
     ...
     cm:add_faction_turn_start_listener_by_name("mortal_worlds_torment",
          Alarielle.faction_key,
          function(context)
               ...
               for r = 0, region_list:num_items() - 1 do
                    if region_list:item_at(r):is_province_capital() == true then
                         average_chaos_corruption =
                             average_chaos_corruption +
                             cm:get_corruption_value_in_region(
                                  region_list:item_at(r), "wh3_main_corruption_chaos");
                         average_khorne_corruption =
                             average_khorne_corruption +
                             cm:get_corruption_value_in_region(
                                  region_list:item_at(r), "wh3_main_corruption_khorne");
                         average_nurgle_corruption =
                             average_nurgle_corruption +
                             cm:get_corruption_value_in_region(
                                  region_list:item_at(r), "wh3_main_corruption_nurgle");
                         average_slaanesh_corruption =
                             average_slaanesh_corruption +
                             cm:get_corruption_value_in_region(
                                  region_list:item_at(r),
               ...
               highest_average_corruption = math.round(
                    highest_average_corruption /
                    num_provinces);
               average_chaos_corruption = math.round(
                    average_chaos_corruption / num_provinces);
               average_khorne_corruption = math.round(
                    average_khorne_corruption /
                    num_provinces);
               average_nurgle_corruption = math.round(
                    average_nurgle_corruption /
                    num_provinces);
               average_slaanesh_corruption = math.round(
                    average_slaanesh_corruption /
                    num_provinces);
               average_tzeentch_corruption = math.round(
                    average_tzeentch_corruption /
                    num_provinces);

               if faction:has_effect_bundle("wh2_dlc10_bundle_alarielle_corruption_0") then
                    cm:remove_effect_bundle("wh2_dlc10_bundle_alarielle_corruption_0",
                         Alarielle.faction_key);
               end

               local effect_bundle = cm:create_new_custom_effect_bundle(
                    "wh2_dlc10_bundle_alarielle_corruption_0");
               effect_bundle:set_duration(0);

               if highest_average_corruption == 0 then
                    effect_bundle:add_effect(
                         "wh2_dlc10_effect_alarielle_corruption_amount_good",
                         "faction_to_faction_own_unseen", highest_average_corruption);
               else
                    effect_bundle:add_effect(
                         "wh2_dlc10_effect_alarielle_corruption_amount",
                         "faction_to_faction_own_unseen", highest_average_corruption);
                    effect_bundle:add_effect(
                         "wh2_dlc10_effect_alarielle_corruption_amount_chaos",
                         "faction_to_faction_own_unseen", average_chaos_corruption);
                    effect_bundle:add_effect(
                         "wh2_dlc10_effect_alarielle_corruption_amount_khorne",
                         "faction_to_faction_own_unseen", average_khorne_corruption);
                    effect_bundle:add_effect(
                         "wh2_dlc10_effect_alarielle_corruption_amount_nurgle",
                         "faction_to_faction_own_unseen", average_nurgle_corruption);
                    effect_bundle:add_effect(
                         "wh2_dlc10_effect_alarielle_corruption_amount_slaanesh",
                         "faction_to_faction_own_unseen", average_slaanesh_corruption);
                    effect_bundle:add_effect(
                         "wh2_dlc10_effect_alarielle_corruption_amount_tzeentch",
                         "faction_to_faction_own_unseen", average_tzeentch_corruption);
               end
               ...
               local trait_level = alarielle:trait_points(
                    "wh2_dlc10_trait_alarielle_chaos");
               trait_level = trait_level -
                   alarielle:trait_points(
                        "wh2_dlc10_trait_alarielle_chaos_none");
               ...
               if highest_average_corruption > 26 then
                    cm:force_add_trait(char_str, "wh2_dlc10_trait_alarielle_chaos",
                         false, 3);
                    core:trigger_event("ScriptEventMortalWorldsTorment4");

                    if trait_level < 3 then
                         cm:trigger_incident_with_targets(faction:command_queue_index(),
                              "wh2_dlc10_incident_hef_alarielle_torment_increase",
                              0, 0,
                              alarielle:command_queue_index(),
                              0, 0, 0);
                    end
               elseif highest_average_corruption > 19 then
                    ...
                    elseif trait_level > 2 then
                         cm:trigger_incident_with_targets(faction:command_queue_index(),
                              "wh2_dlc10_incident_hef_alarielle_torment_decrease",
                              0, 0,
                              alarielle:command_queue_index(),
                              0, 0, 0);
                    end
               elseif highest_average_corruption > 13 then
                    ...
                    cm:force_add_trait(char_str, "wh2_dlc10_trait_alarielle_chaos_none",
                         false);
     ...
     if cm:get_faction(Alarielle.faction_key):is_human() then
          core:add_listener("defender_of_ulthuan_region_update",
               "RegionFactionChangeEvent", function(context)
                    return ulthuan_regions["all"] and
                        ulthuan_regions["all"][context:region():name()];
                    ...
                    if not region:is_null_interface() then
                         ...
                         if ulthuan_type ~= nil then
                              if ulthuan_regions[ulthuan_type][region_key] and
                                  region:is_abandoned() or
                                  region:owning_faction():culture() ~=
                                  "wh2_main_hef_high_elves" then
                                   ulthuan_regions[ulthuan_type][region_key] = false;
                                   ulthuan_regions[ulthuan_type .. "_lost"] =
                                       ulthuan_regions[ulthuan_type .. "_lost"] + 1;
                                   self.out(
                                        "\tRegion was true and is now false - Value " ..
                                        ulthuan_type .. "_lost count is " ..
                                        tostring(
                                             ulthuan_regions[ulthuan_type .. "_lost"]) ..
                                        " (+1)");
                              elseif not ulthuan_regions[ulthuan_type][region_key] and
                                  not region:is_abandoned() and
                                  region:owning_faction():culture() ==
                                  "wh2_main_hef_high_elves" then
                                   ...
                                   ulthuan_regions[ulthuan_type .. "_lost"] =
                                       ulthuan_regions[ulthuan_type .. "_lost"] - 1;
                                   self.out(
                                        "\tRegion was false and is now true - Value " ..
                                        ulthuan_type .. "_lost count is " ..
                                        tostring(
                                             ulthuan_regions[ulthuan_type .. "_lost"]) ..
                                        " (-1)");
                              ...
                              if ulthuan_regions["inner_lost"] > 0 then
                                   if defender_of_ulthuan_effect ==
                                       "wh2_dlc10_defender_of_ulthuan_all" or
                                       defender_of_ulthuan_effect ==
                                       "wh2_dlc10_defender_of_ulthuan_outer" then
                                   ...
                                   defender_of_ulthuan_effect =
                                   "wh2_dlc10_defender_of_ulthuan_inner";
                              elseif ulthuan_regions["outer_lost"] > 0 then
                                   if defender_of_ulthuan_effect ==
                                       "wh2_dlc10_defender_of_ulthuan_all" then
                                        defender_of_ulthuan_show_event(region, "outer_lost");
                                        core:trigger_event(
                                             "ScriptEventDefenderOfUlthuanOuterLost");
                                   elseif defender_of_ulthuan_effect ==
                                       "wh2_dlc10_defender_of_ulthuan_inner" then
                                        core:trigger_event(
                                             "ScriptEventDefenderOfUlthuanInnerRegained");
                                   end

                                   defender_of_ulthuan_effect =
                                   "wh2_dlc10_defender_of_ulthuan_outer";
                              else
                                   if defender_of_ulthuan_effect ==
                                       "wh2_dlc10_defender_of_ulthuan_outer" or
                                       defender_of_ulthuan_effect ==
                                       "wh2_dlc10_defender_of_ulthuan_inner" then
                                        ...
                                        cm:complete_scripted_mission_objective(
                                             Alarielle.faction_key, "wh_main_short_victory",
                                             "ulthuan_controlled", true);
                                   end

                                   defender_of_ulthuan_effect =
                                   "wh2_dlc10_defender_of_ulthuan_all";
                              end

                              defender_of_ulthuan_level = 1;
                              cm:apply_effect_bundle(
                                   defender_of_ulthuan_effect .. "_" ..
                                   defender_of_ulthuan_level, Alarielle.faction_key, 0);
                         end
                    end
               end, true);

          cm:add_faction_turn_start_listener_by_name("defender_of_ulthuan_update",
               Alarielle.faction_key,
               function()
                    ...
                    defender_of_ulthuan_remove_effects();
                    cm:apply_effect_bundle(defender_of_ulthuan_effect .. "_" ..
                         defender_of_ulthuan_level,
                         Alarielle.faction_key, 0);
               end, true);
          ...
          if cm:is_new_game() then
               ...
               cm:apply_effect_bundle_to_region("wh2_dlc10_dark_elf_fortress_gate",
...
function defender_of_ulthuan_initialize(new_game)
     ...
     for i = 1, #ulthuan_types do
          for region_key, value in pairs(ulthuan_regions[ulthuan_types[i]]) do
               ...
               if region and
                   (region:is_abandoned() or region:owning_faction():culture() ~=
                        "wh2_main_hef_high_elves") then
                    ulthuan_regions[ulthuan_types[i]][region_key] = false;
                    ulthuan_regions[ulthuan_types[i] .. "_lost"] =
                        ulthuan_regions[ulthuan_types[i] .. "_lost"] + 1;
               end
          end
     end
     ...
     if new_game then defender_of_ulthuan_level = 1; end
     ...
     cm:apply_effect_bundle(defender_of_ulthuan_effect .. "_" ..
          defender_of_ulthuan_level, Alarielle.faction_key,
          0);
end
...
function defender_of_ulthuan_remove_effects()
     ...
     for i = 1, 10 do
          for j = 1, #effects do
               local effect_bundle =
                   "wh2_dlc10_defender_of_ulthuan_" .. effects[j] .. "_" .. i;
...
function defender_of_ulthuan_show_event(region, event_type)
     if event_type == "united" then
          cm:show_message_event(Alarielle.faction_key,
          ...
          cm:show_message_event_located(Alarielle.faction_key,
               "event_feed_strings_text_" ..
               "wh2_dlc10_event_feed_string_scripted_event_defender_of_ulthuan_title",
               "event_feed_strings_text_" ..
               "wh2_dlc10_event_feed_string_scripted_event_defender_of_ulthuan_" ..
               event_type .. "_primary_detail",
               "event_feed_strings_text_" ..
               "wh2_dlc10_event_feed_string_scripted_event_defender_of_ulthuan_" ..
               event_type .. "_secondary_detail",
               settlement:logical_position_x(),
               settlement:logical_position_y(), false,
               1013);
     end
end
...
cm:add_saving_game_callback(function(context)
     cm:save_named_value("defender_of_ulthuan_level", defender_of_ulthuan_level,
          context)
     cm:save_named_value("Power_of_Nature_Regions", Power_of_Nature.regions,
          context)
end)

cm:add_loading_game_callback(function(context)
     defender_of_ulthuan_level = cm:load_named_value("defender_of_ulthuan_level",
          1, context)
     Power_of_Nature.regions = cm:load_named_value("Power_of_Nature_Regions", {},
          context)
end)
