    ...
    trait_exclusions = {
        ["culture"] = {
            ["wh2_main_trait_corrupted_chaos"] = {
                "wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh_dlc03_bst_beastmen", "wh2_main_skv_skaven", "wh3_main_dae_daemons", "wh3_main_kho_khorne", "wh3_main_nur_nurgle",
                "wh3_main_sla_slaanesh", "wh3_main_tze_tzeentch", "wh3_dlc23_chd_chaos_dwarfs"},
            ["wh2_main_trait_corrupted_vampire"] = {"wh_main_vmp_vampire_counts", "wh2_dlc09_tmb_tomb_kings", "wh2_dlc11_cst_vampire_coast"},
            ["wh2_main_trait_corrupted_skaven"] = {
                "wh2_main_skv_skaven", "wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh_dlc03_bst_beastmen", "wh3_main_dae_daemons", "wh3_main_kho_khorne", "wh3_main_nur_nurgle",
                "wh3_main_sla_slaanesh", "wh3_main_tze_tzeentch", "wh3_dlc23_chd_chaos_dwarfs"},
            ...
            ["wh3_main_trait_corrupted_slaanesh"] = {"wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh_dlc03_bst_beastmen", "wh3_main_dae_daemons", "wh3_main_sla_slaanesh", "wh3_dlc23_chd_chaos_dwarfs"},
            ["wh3_main_trait_corrupted_tzeentch"] = {"wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh_dlc03_bst_beastmen", "wh3_main_dae_daemons", "wh3_main_tze_tzeentch", "wh3_dlc23_chd_chaos_dwarfs"},
            ["wh2_main_trait_pacifist"] = {
                "wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh_dlc03_bst_beastmen", "wh3_main_dae_daemons", "wh3_main_kho_khorne", "wh3_main_nur_nurgle", "wh3_main_sla_slaanesh",
                "wh3_main_tze_tzeentch", "wh3_dlc23_chd_chaos_dwarfs"},
            ["wh2_main_trait_stance_recruiting"] = {"wh2_dlc09_tmb_tomb_kings", "wh_dlc03_bst_beastmen"},
            ["wh2_main_trait_defeats_against_chaos"] = {
                "wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh3_main_dae_daemons", "wh3_main_kho_khorne", "wh3_main_nur_nurgle", "wh3_main_sla_slaanesh", "wh3_main_tze_tzeentch",
                "wh3_dlc23_chd_chaos_dwarfs"},
            ["wh2_main_trait_defeats_against_daemons"] = {
                "wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh3_main_dae_daemons", "wh3_main_kho_khorne", "wh3_main_nur_nurgle", "wh3_main_sla_slaanesh", "wh3_main_tze_tzeentch",
                "wh3_dlc23_chd_chaos_dwarfs"},
            ["wh2_main_trait_agent_actions_against_chaos"] = {
                "wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh3_main_dae_daemons", "wh3_main_kho_khorne", "wh3_main_nur_nurgle", "wh3_main_sla_slaanesh", "wh3_main_tze_tzeentch",
                "wh3_dlc23_chd_chaos_dwarfs"},
            ["wh2_main_trait_agent_actions_against_daemons"] = {
                "wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh3_main_dae_daemons", "wh3_main_kho_khorne", "wh3_main_nur_nurgle", "wh3_main_sla_slaanesh", "wh3_main_tze_tzeentch",
                "wh3_dlc23_chd_chaos_dwarfs"},
            ["wh2_main_trait_wins_against_chaos"] = {
                "wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh3_main_dae_daemons", "wh3_main_kho_khorne", "wh3_main_nur_nurgle", "wh3_main_sla_slaanesh", "wh3_main_tze_tzeentch",
                "wh3_dlc23_chd_chaos_dwarfs"},
            ["wh2_main_trait_wins_against_daemons"] = {
                "wh_main_chs_chaos", "wh_dlc08_nor_norsca", "wh3_main_dae_daemons", "wh3_main_kho_khorne", "wh3_main_nur_nurgle", "wh3_main_sla_slaanesh", "wh3_main_tze_tzeentch",
                "wh3_dlc23_chd_chaos_dwarfs"},
        ...
        ["faction"] = {
            ["wh2_main_trait_corrupted_chaos"] = {"wh2_main_def_cult_of_pleasure", "wh2_main_def_cult_of_pleasure_separatists", "wh2_dlc13_lzd_spirits_of_the_jungle", "wh2_dlc17_lzd_oxyotl"},
            ["wh3_main_trait_corrupted_slaanesh"] = {"wh2_main_def_cult_of_pleasure", "wh2_main_def_cult_of_pleasure_separatists"},
...
-------------------------------------------
events.CharacterCharacterTargetAction[#events.CharacterCharacterTargetAction + 1] = function(context)
    if context:ability() ~= "assist_army" and (context:mission_result_success() or context:mission_result_critial_success()) then
        ...
        -- removed check against own subculture.
        -- if subculture ~= own_subculture and

        if campaign_traits.subcultures_trait_keys[subculture] ~= nil then
...
events.CharacterGarrisonTargetAction[#events.CharacterGarrisonTargetAction + 1] = function(context)
...
events.CharacterParticipatedAsSecondaryGeneralInBattle[#events.CharacterParticipatedAsSecondaryGeneralInBattle + 1] = function(context)
    campaign_traits:general_completed_battle(context);
end
...
function campaign_traits:give_traits_for_fighting_subcultures(character, faction_name)
    ...
    -- removing own subculture check
    -- if character:faction():subculture() ~= enemy_subculture and 

    if self.subcultures_trait_keys[enemy_subculture] ~= nil then
        if character:won_battle() == true then
...
--------------------------------
events.CharacterTurnStart[#events.CharacterTurnStart + 1] = function(context)
    local character = context:character();
...
---- SACKING SETTLEMENTS ----
-----------------------------
events.CharacterSackedSettlement[#events.CharacterSackedSettlement + 1] = function(context)
    if cm:char_is_general_with_army(context:character()) then
...
---- RAZING SETTLEMENTS ----
-----------------------------
events.CharacterRazedSettlement[#events.CharacterRazedSettlement + 1] = function(context)
    if cm:char_is_general_with_army(context:character()) then
...
-------------------------------
events.CharacterPostBattleCaptureOption[#events.CharacterPostBattleCaptureOption + 1] = function(context)
...
events.CharacterTurnStart[#events.CharacterTurnStart + 1] = function(context)
    ...
    if character:faction():is_human() and character:has_region() and character:faction():is_allowed_to_capture_territory() and cm:char_is_general_with_army(character) and
        cm:model():campaign_name_key() ~= "wh3_main_prologue" then
...
events.CharacterTurnStart[#events.CharacterTurnStart + 1] = function(context)
    ...
    if character:has_region() then
        ...
        local corruption_to_trait = {
            {chaos_corruption_string, "wh2_main_trait_corrupted_chaos"}, {vampiric_corruption_string, "wh2_main_trait_corrupted_vampire"},
            {khorne_corruption_string, "wh3_main_trait_corrupted_khorne"}, {nurgle_corruption_string, "wh3_main_trait_corrupted_nurgle"},
            {slaanesh_corruption_string, "wh3_main_trait_corrupted_slaanesh"}, {tzeentch_corruption_string, "wh3_main_trait_corrupted_tzeentch"}}
...
--------------------------------------------
events.BuildingCompleted[#events.BuildingCompleted + 1] = function(context)
    ...
    if faction:character_list():num_items() > 1 then
        for i = 0, faction:character_list():num_items() - 1 do
            ...
            -- bookmark making this trait based on being in the province rather than in the region.
            if builder:has_region() and cm:char_is_general_with_army(builder) and builder:region():province_name() == building:region():province_name() then
                -- :region():name() == building:region():name() then
...
events.CharacterCompletedBattle[#events.CharacterCompletedBattle + 1] = function(context)
    ...
    if cm:char_is_general_with_army(character) then
        ...
        -- made this easier to get since I play with half replenishment.
        if losses >= 0.4 then
