...
function Power_of_Nature:Start_Power_of_Nature_Listeners()
     cm:add_faction_turn_start_listener_by_name("Power_of_Nature", alarielle_faction_key, function(context)
          ...
          if character:has_region() and not character:is_at_sea() then
               ...
               ", region_owning_faction:name() == " .. region_owning_faction:name() .. "")
...
function add_alarielle_listeners()
     ...
     cm:add_faction_turn_start_listener_by_name("mortal_worlds_torment", alarielle_faction_key, function(context)
          ...
          for r = 0, region_list:num_items() - 1 do
               if region_list:item_at(r):is_province_capital() == true then
                    average_chaos_corruption = average_chaos_corruption +
                    cm:get_corruption_value_in_region(region_list:item_at(r), "wh3_main_corruption_chaos");
                    average_khorne_corruption = average_khorne_corruption +
                    cm:get_corruption_value_in_region(region_list:item_at(r), "wh3_main_corruption_khorne");
                    average_nurgle_corruption = average_nurgle_corruption +
                    cm:get_corruption_value_in_region(region_list:item_at(r), "wh3_main_corruption_nurgle");
                    average_slaanesh_corruption = average_slaanesh_corruption +
                    cm:get_corruption_value_in_region(region_list:item_at(r), "wh3_main_corruption_slaanesh");
                    average_tzeentch_corruption = average_tzeentch_corruption +
          ...
          if highest_average_corruption == 0 then
               effect_bundle:add_effect("wh2_dlc10_effect_alarielle_corruption_amount_good",
                    "faction_to_faction_own_unseen", highest_average_corruption);
          else
               effect_bundle:add_effect("wh2_dlc10_effect_alarielle_corruption_amount", "faction_to_faction_own_unseen",
                    highest_average_corruption);
               effect_bundle:add_effect("wh2_dlc10_effect_alarielle_corruption_amount_chaos",
                    "faction_to_faction_own_unseen", average_chaos_corruption);
               effect_bundle:add_effect("wh2_dlc10_effect_alarielle_corruption_amount_khorne",
                    "faction_to_faction_own_unseen", average_khorne_corruption);
               effect_bundle:add_effect("wh2_dlc10_effect_alarielle_corruption_amount_nurgle",
                    "faction_to_faction_own_unseen", average_nurgle_corruption);
               effect_bundle:add_effect("wh2_dlc10_effect_alarielle_corruption_amount_slaanesh",
                    "faction_to_faction_own_unseen", average_slaanesh_corruption);
               effect_bundle:add_effect("wh2_dlc10_effect_alarielle_corruption_amount_tzeentch",
          ...
          if highest_average_corruption > 26 then
               ...
               if trait_level < 3 then
                    cm:trigger_incident_with_targets(faction:command_queue_index(),
                         "wh2_dlc10_incident_hef_alarielle_torment_increase", 0, 0, alarielle:command_queue_index(), 0, 0,
                         0);
               end
          elseif highest_average_corruption > 19 then
               ...
               elseif trait_level > 2 then
                    cm:trigger_incident_with_targets(faction:command_queue_index(),
                         "wh2_dlc10_incident_hef_alarielle_torment_decrease", 0, 0, alarielle:command_queue_index(), 0, 0,
                         0);
               end
     ...
     if cm:get_faction(alarielle_faction_key):is_human() then
               ...
               if not region:is_null_interface() then
                    ...
                    if ulthuan_type ~= nil then
                         if ulthuan_Regions[ulthuan_type][region_key] and region:is_abandoned() or region:owning_faction():culture() ~= "wh2_main_hef_high_elves" then
                              ...
                              self.out("\tRegion was true and is now false - Value " ..
                              ulthuan_type ..
                              "_lost count is " .. tostring(ulthuan_Regions[ulthuan_type .. "_lost"]) .. " (+1)");
                         elseif not ulthuan_Regions[ulthuan_type][region_key] and not region:is_abandoned() and region:owning_faction():culture() == "wh2_main_hef_high_elves" then
                              ...
                              ulthuan_Regions[ulthuan_type .. "_lost"] = ulthuan_Regions[ulthuan_type .. "_lost"] - 1;
                              self.out("\tRegion was false and is now true - Value " ..
                              ulthuan_type ..
                              "_lost count is " .. tostring(ulthuan_Regions[ulthuan_type .. "_lost"]) .. " (-1)");
                         else
                         ...
                         elseif ulthuan_Regions["outer_lost"] > 0 then
                              ...
                              if defender_of_ulthuan_effect == "wh2_dlc10_defender_of_ulthuan_outer" or defender_of_ulthuan_effect == "wh2_dlc10_defender_of_ulthuan_inner" then
                                   ...
                                   cm:complete_scripted_mission_objective(alarielle_faction_key, "wh_main_short_victory",
                         ...
                         cm:apply_effect_bundle(defender_of_ulthuan_effect .. "_" .. defender_of_ulthuan_level,
                              alarielle_faction_key, 0);
                    end
               end
          end, true);

          cm:add_faction_turn_start_listener_by_name("defender_of_ulthuan_update", alarielle_faction_key, function()
          ...
          if cm:is_new_game() then
               ...
               cm:apply_effect_bundle_to_region("wh2_dlc10_dark_elf_fortress_gate", "wh3_main_combi_region_phoenix_gate",
                    0);
          else
...
function defender_of_ulthuan_show_event(region, event_type)
     if event_type == "united" then
          cm:show_message_event(alarielle_faction_key,
          ...
          cm:show_message_event_located(alarielle_faction_key,
               "event_feed_strings_text_" .. "wh2_dlc10_event_feed_string_scripted_event_defender_of_ulthuan_title",
               "event_feed_strings_text_" ..
               "wh2_dlc10_event_feed_string_scripted_event_defender_of_ulthuan_" .. event_type .. "_primary_detail",
               "event_feed_strings_text_" ..
               "wh2_dlc10_event_feed_string_scripted_event_defender_of_ulthuan_" .. event_type .. "_secondary_detail",
