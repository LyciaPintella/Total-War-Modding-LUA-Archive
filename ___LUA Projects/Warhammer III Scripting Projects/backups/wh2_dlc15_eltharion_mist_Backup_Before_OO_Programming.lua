...
local m_regions = {
    ...
    level_3 = {
        ...
        "wh3_main_combi_region_tor_dranil", "wh3_main_combi_region_tor_anlec", "wh3_main_combi_region_shrine_of_khaine", "wh3_main_combi_region_tor_achare", "wh3_main_combi_region_shrine_of_kurnous",
        "wh3_main_combi_region_elisia", "wh3_main_combi_region_mistnar", "wh3_main_combi_region_tor_koruali", "wh3_main_combi_region_tor_yvresse", "wh3_main_combi_region_elessaeli",
        "wh3_main_combi_region_tralinia", "wh3_main_combi_region_shrine_of_loec", "wh3_main_combi_region_cairn_thel", "wh3_main_combi_region_lothern", "wh3_main_combi_region_angerrial"}
}
...
local function apply_mists_of_yvresse_effects(region_key)
    ...
    if not region:is_null_interface() and not region:is_abandoned() then
        ...
        if owning_faction:culture() == m_hef_culture and
            ((owning_faction:name() == m_eltharion_faction_key) or owning_faction:allied_with(yvresse_faction) or owning_faction:is_vassal_of(yvresse_faction) or
...
function add_eltharion_mist_listeners()
    ...
    cm:add_faction_turn_start_listener_by_name("mist_of_yvresse_monitor", m_eltharion_faction_key, function(context)
