local Eltharion_Mists = {
     ...
     m_regions = {
          ...
          level_2 = { "wh3_main_combi_region_tor_yvresse", "wh3_main_combi_region_elessaeli",
               "wh3_main_combi_region_tralinia", "wh3_main_combi_region_shrine_of_loec",
               "wh3_main_combi_region_cairn_thel" },
          -- outer ring
          level_3 = {
               "wh3_main_combi_region_vauls_anvil_ulthuan", "wh3_main_combi_region_tor_sethai",
               "wh3_main_combi_region_avethir", "wh3_main_combi_region_whitepeak", "wh3_main_combi_region_tor_anroc",
               "wh3_main_combi_region_tor_dranil", "wh3_main_combi_region_tor_anlec",
               "wh3_main_combi_region_shrine_of_khaine", "wh3_main_combi_region_tor_achare",
               "wh3_main_combi_region_shrine_of_kurnous", "wh3_main_combi_region_elisia",
               "wh3_main_combi_region_mistnar", "wh3_main_combi_region_tor_koruali", "wh3_main_combi_region_tor_yvresse",
               "wh3_main_combi_region_elessaeli", "wh3_main_combi_region_tralinia",
               "wh3_main_combi_region_shrine_of_loec", "wh3_main_combi_region_cairn_thel",
...
function add_eltharion_mist_listeners()
     ...
     cm:add_faction_turn_start_listener_by_name("mist_of_yvresse_monitor", Eltharion_Mists.m_eltharion_faction_key,
          function(context)
     ...
     core:add_listener("mist_ritual_unlock", "RitualCompletedEvent", function(context)
          ...
          return ritual:ritual_key() == "wh2_dlc15_ritual_hef_ladrielle" or
          ritual:ritual_chain_key() == "wh2_dlc15_athel_tamarha_mist"
     ...
     core:add_listener("mist_region_captured_update", "GarrisonOccupiedEvent", function(context)
          return context:garrison_residence():faction():name() == Eltharion_Mists.m_eltharion_faction_key or
          context:character():faction():name() == Eltharion_Mists.m_eltharion_faction_key
     end, function()
          Eltharion_Mists:update_mists_of_yvresse()
     end, true)
