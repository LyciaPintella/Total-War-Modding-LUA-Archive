...
local lair_autoresolve_capture_chance = 100;
...
function add_eltharion_lair_listeners()
               ...
               cm:callback(
                    function()
                         ...
                         if faction:has_effect_bundle("wh2_dlc15_bundle_indoctrinated_prisoner_influence") then
                              cm:remove_effect_bundle("wh2_dlc15_bundle_indoctrinated_prisoner_influence",
                                   yvresse_faction_key);
                         end
                    end,
                    1
     ...
     core:add_listener(
          ...
          function(context)
               ...
               return faction:name() == yvresse_faction_key and faction:is_human();
          end,
          function(context)
               local character = context:character();
               ...
               if character:rank() >= lair_mistwalker_level then
                    ...
                    if trait_level < 1 then
                         cm:trigger_dilemma_with_targets(character:faction():command_queue_index(),
                              "wh2_dlc15_hef_mistwalker_recruitment", 0, 0, character:command_queue_index(), 0, 0, 0);
                    end
               end
          end,
          true
     ...
     core:add_listener(
          ...
          function(context)
               ...
               if ritual_key == "wh2_dlc15_athel_tamarha_mistwalkers_recruitment_2" then
                    cm:remove_event_restricted_building_record_for_faction("wh2_dlc15_hef_field_hq_1",
                         yvresse_faction_key);
                    cm:remove_event_restricted_building_record_for_faction("wh2_dlc15_hef_field_hq_2",
                         yvresse_faction_key);
                    cm:remove_event_restricted_building_record_for_faction("wh2_dlc15_hef_field_hq_3",
                         yvresse_faction_key);
               ...
               if upgrade_value then
                    cm:faction_add_pooled_resource(yvresse_faction_key, "yvresse_defence",
                         "wh2_dlc15_resource_factor_yvresse_defence_upgrade", upgrade_value);
               end
          end,
          true
     );
     ...
     core:add_listener(
          ...
          function(context)
               ...
               if action == "wh2_dlc15_prison_action_indoctrinate" then
                    cm:faction_add_pooled_resource(yvresse_faction_key, "wardens_supply",
                         "wh2_dlc15_resource_factor_wardens_supply_indoctrinated_prisoners", lair_indoctrinate_supply);
                    cm:apply_effect_bundle("wh2_dlc15_bundle_indoctrinated_prisoner_influence", yvresse_faction_key, 0);
                    cm:trigger_incident_with_targets(warden_cqi, "wh2_dlc15_incident_hef_prisoner_indoctrinated", 0,
                         faction_cqi, prisoner_cqi, 0, 0, 0);
               ...
               elseif action == "wh2_dlc15_prison_action_execute" then
                    cm:faction_add_pooled_resource(yvresse_faction_key, "wardens_supply",
                         "wh2_dlc15_resource_factor_wardens_supply_executed_prisoners", lair_execute_supply);
                    cm:apply_effect_bundle("wh2_dlc15_bundle_executed_prisoner_influence", yvresse_faction_key, 0);
                    cm:trigger_incident_with_targets(warden_cqi, "wh2_dlc15_incident_hef_prisoner_executed", 0,
                         faction_cqi, prisoner_cqi, 0, 0, 0);
                    cm:remove_effect_bundle("wh2_dlc15_hef_dungeon_execute", yvresse_faction_key);

                    cm:add_agent_experience(cm:char_lookup_str(warden:faction_leader()), 675);
               ...
               elseif action:starts_with("wh2_dlc15_prison_action_interrogate") then
                    ...
                    if is_grom then
                         cm:apply_effect_bundle("wh2_dlc15_hef_dungeon_mistwalker_upgrade_greenskins_grom",
                              yvresse_faction_key, 0);
                    end
               end
     ...
     core:add_listener(
          ...
          function(context)
               ...
               return building:faction():name() == yvresse_faction_key and
               context:garrison_residence():region():name() == "wh3_main_combi_region_tor_yvresse" and
               building:chain() == "wh2_dlc15_special_settlement_tor_yvresse_eltharion";
          end,
          function(context)
               ...
               if lair_max_yvresse_level == 4 and building_level == 5 then
                    ...
                    cm:faction_add_pooled_resource(yvresse_faction_key, "yvresse_defence",
                         "wh2_dlc15_resource_factor_yvresse_defence_settlement", 10);
               ...
               elseif lair_max_yvresse_level == 2 and building_level == 3 then
                    lair_max_yvresse_level = lair_max_yvresse_level + 1;
                    cm:faction_add_pooled_resource(yvresse_faction_key, "yvresse_defence",
                         "wh2_dlc15_resource_factor_yvresse_defence_settlement", 5);
               end
          end,
          true
     );
          ...
          function()
               ...
               if pending_battle:is_auto_resolved() then
                    ...
                    if prisoners:num_items() < lair_max_prisoners then
                         if cm:pending_battle_cache_faction_is_attacker(yvresse_faction_key) and pending_battle:has_been_fought() and not pending_battle:ended_with_withdraw() then
          ...
          function(context)
               ...
               if rejection_reasons:is_member_of_garrison() or rejection_reasons:is_from_rebel_faction() or rejection_reasons:is_from_companion_faction() then
                    ...
                    if not prisoner:is_null_interface() then
                         ...
                         cm:trigger_incident_with_targets(context:faction():command_queue_index(),
                              "wh2_dlc15_incident_hef_prisoner_failed_capture", 0,
                              character:faction():command_queue_index(), character:command_queue_index(), 0, 0, 0);
                    end
               end
          end,
          true
     ...
     if cm:is_new_game() then
          local warden = cm:get_faction(yvresse_faction_key);
          lair_UpdatePrisonAbility(warden);
          cm:add_event_restricted_building_record_for_faction("wh2_dlc15_hef_field_hq_1", yvresse_faction_key,
               "eltharion_building_lock_hq");
          cm:add_event_restricted_building_record_for_faction("wh2_dlc15_hef_field_hq_2", yvresse_faction_key,
               "eltharion_building_lock_hq");
          cm:add_event_restricted_building_record_for_faction("wh2_dlc15_hef_field_hq_3", yvresse_faction_key,
               "eltharion_building_lock_hq");
...
core:add_listener(
     ...
     function(context)
          ...
          lair_UpdatePrisonAbility(warden);
          lair_UpdatePrisonerEffects(warden);
          cm:trigger_incident_with_targets(warden:command_queue_index(), "wh2_dlc15_incident_hef_prisoner_captured", 0,
               character:faction():command_queue_index(), character:command_queue_index(), 0, 0, 0);
     end,
     true
)
...
cm:add_loading_game_callback(
     function(context)
          if not cm:is_new_game() then
               ...
               lair_indoctrinated_characters = cm:load_named_value("lair_indoctrinated_characters",
                    lair_indoctrinated_characters, context);
               lair_improved_interrogate = cm:load_named_value("lair_improved_interrogate", lair_improved_interrogate,
                    context);
               ...
               lair_interrogated_prisoner = cm:load_named_value("lair_interrogated_prisoner", lair_interrogated_prisoner,
                    context);
               lair_interrogated_effect = cm:load_named_value("lair_interrogated_effect", lair_interrogated_effect,
                    context);
          end
     end
);