campaign_experience_triggers = {
	...
	xp_battle_modifier_secondary_general = 1, -- this is the modifier to the above values when the participating character is a reinforcing Lord
...
function campaign_experience_triggers:setup_experience_triggers()
	core:add_listener("CharacterTurnStart_experience", "CharacterTurnStart", function()
	...
	core:add_listener("GarrisonOccupiedEvent_experience", "GarrisonOccupiedEvent", true, function(context)
		self:add_experience(context, true, self.xp_general_occupies_settlement)
	end, true)
	core:add_listener("CharacterRazedSettlement_experience", "CharacterRazedSettlement", true, function(context)
		self:add_experience(context, true, self.xp_general_razes_settlement)
	end, true)
	core:add_listener("CaravanCompleted_experience", "CaravanCompleted", true, function(context)
	...
	core:add_listener("MilitaryForceBuildingCompleteEvent_experience", "MilitaryForceBuildingCompleteEvent", true, function(context)
		self:add_experience(context, true, self.xp_general_completes_horde_building)
	end, true)
	core:add_listener("CharacterGarrisonTargetAction_experience", "CharacterGarrisonTargetAction", true, function(context)
	...
	core:add_listener("CharacterCharacterTargetAction_experience", "CharacterCharacterTargetAction", true, function(context)
	...
	core:add_listener("CharacterCompletedBattle_experience", "CharacterCompletedBattle", true, function(context)
		self:calculate_battle_result_experience(context, true, false)
	end, true)
	core:add_listener("HeroCharacterParticipatedInBattle_experience", "HeroCharacterParticipatedInBattle", true, function(context)
		self:calculate_battle_result_experience(context, false, false)
	end, true)
	core:add_listener("CharacterParticipatedAsSecondaryGeneralInBattle_experience", "CharacterParticipatedAsSecondaryGeneralInBattle", true, function(context)
